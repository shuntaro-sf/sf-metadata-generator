...
const inputFilePath = './test/resources/input/object/object_positiveTestInput.csv';
...
describe('metadata object generate positive NUTs', () => {
  ...
  it('metadata object generate positive', async () => {
