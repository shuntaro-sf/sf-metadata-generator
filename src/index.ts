...
export const listviewConvertConfig = {
  header: [
    'fullName',
    'label',
    'columns',
...
export const listviewGenerateConfig = {
  ...
  defaultValues: {
    ...
    sharedToRole: null,
    sharedToGroup: null,
    sharedToRoleAndSubordinates: null,
  },
  isRequired: {
    fullName: true,
    label: true,
    ...
    sharedTo: false,
    sharedToGroup: false,
    sharedToRoleAndSubordinates: false,
  },
...
export const listviewTemplateConfig = {
  template: {
    rowMine: {
      fullName: 'MineListView',
      label: 'MineListView',
    ...
    rowRole: {
      ...
      filtersValue: '',
      sharedToRole: 'CFO',
      sharedToRoleAndSubordinates: 'COO',
      sharedToGroup: '',
    },
    rowGroup: {
      fullName: 'GroupListView',
      label: 'GroupListView',
      columns: 'ACCOUNT.NAME;ACCOUNT.SITE;ACCOUNT.ADDRESS1_STATE;ACCOUNT.PHONE1;ACCOUNT.TYPE;CORE.USERS.ALIAS',
      filterScope: 'ScopingRule',
      filtersField: '',
      filtersOperation: '',
      filtersValue: '',
      sharedToRole: '',
...
export const objectGenerateConfig = {
  ...
  isRequired: {
    ...
    sharingModel: true,
    externalSharingModel: true,
    description: false,
    nameFieldType: true,
    nameFieldLabel: true,
    nameFieldDisplayFormat: true,
  },
  ...
  options: {
    ...
    sharingModel: ['Private', 'ReadWrite', 'ReadOnly', 'ReadWriteTransfer', 'ControlledByParent'],
    externalSharingModel: ['Private', 'ReadWrite', 'ReadOnly', 'ReadWriteTransfer', 'ControlledByParent'],
  },
  indentationLength: 4,
  objectExtension: '.object-meta.xml',
  delimiter: ',',
...
export const tabTemplateConfig = {
  template: {
    ...
    LightningComponent: {
      fullName: 'LightningComponent',
      label: 'LightningComponent',
      type: 'LightningComponent',
      description: '',
      customObject: '',
      flexiPage: 'LightningComponent',
      frameHeight: '',
      hasSidebar: '',
