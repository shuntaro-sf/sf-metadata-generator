...
export default class Template extends SfCommand<FieldTemplateResult> {
  ...
  private static templateInput = TemplateData.fieldTemplateConfig.template as TemplateInput;

  public async run(): Promise<FieldTemplateResult> {
